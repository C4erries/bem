...
export class OverthrowSpawnItem{
    ...
    SpecialItemAdd( event : DotaItemPickedUpEvent){
        ...
        const t1 = PickRandomShuffle( tier1, this.tier1ItemBucket )
        const t2 = PickRandomShuffle( tier2, this.tier2ItemBucket )
        const t3 = PickRandomShuffle( tier3, this.tier3ItemBucket )
        const t4 = PickRandomShuffle( tier4, this.tier4ItemBucket )
        const t5 = PickRandomShuffle( tier5, this.tier5ItemBucket )
